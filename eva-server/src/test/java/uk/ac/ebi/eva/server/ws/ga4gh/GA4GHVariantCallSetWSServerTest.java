...
public class GA4GHVariantCallSetWSServerTest {
    ...
    public void testGetCallSetsNotExisting() {
        GASearchCallSetsResponse gaSearchCallSetsResponse = testGetCallSetsHelper(Collections.singletonList("otherFileId"));
        assertEquals(0, gaSearchCallSetsResponse.getCallSets().size());
    }
