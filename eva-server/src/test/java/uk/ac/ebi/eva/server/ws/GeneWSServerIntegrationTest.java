...
public class GeneWSServerIntegrationTest {
    ...
    private void testGetVariantsByGeneHelper(String testRegion, int expectedVariants) throws URISyntaxException {
    ...
    private List<VariantWithSamplesAndAnnotation> regionWsHelper(String testGene) {
    ...
    private List<VariantWithSamplesAndAnnotation> testExcludeHelper(String testRegion, String testExclusion) {
        String url = "/v1/genes/" + testRegion + "/variants?species=mmusculus_grcm38&exclude=" + testExclusion;
        return testRestTemplateHelper(url);
    }

    @Test
    public void testVepVersionAndVepCacheVersionFilter() {
        String testRegion = "DDX11L5";
        String annotationVepVersion = "78";
        String annotationVepCacheversion = "78";
        String url = "/v1/genes/" + testRegion +
